...
export const angkatanStyles = StyleSheet.create({
  ...
  tableHeaderRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: PALETTE.surface },
  tableHeaderCell: { flex: 1, minWidth: 90, padding: 12, fontSize: 11, fontWeight: '800', color: PALETTE.textMutedDark, textAlign: 'center', letterSpacing: 0.3 },
  ...
  tableCell: { flex: 1, minWidth: 90, padding: 12, textAlign: 'center', color: PALETTE.textMutedDark, fontSize: 13 },
